...
export const dict = {
  ka: {
    ...
    beta: "ბეტა",
    email_placeholder: "შეიყვანე ელ-ფოსტა",
    send_magic_link: "Magic Link-ის გაგზავნა",
    magic_link_sent: "შეამოწმე შენი ელ-ფოსტა! ლინკი გამოგეგზავნა.",
    or_divider: "ან",
    sending: "იგზავნება...",
    invalid_email: "შეიყვანე სწორი ელ-ფოსტა",
    // nav
    nav_swipe: "სვაიპი",
    nav_explore: "ძიება",
    nav_likes: "მოწონება",
  ...
  en: {
    ...
    magic_link_sent: "Check your email! A login link was sent.",
    or_divider: "or",
    sending: "Sending...",
